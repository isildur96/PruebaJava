...
public class VentanaEditarAmigo extends JFrame {
	...
	private void IniciarComponentes() {
		...
		/* Etiquetas */
		lblTitulo = new JLabel("Editar Amigo");
		...
		lblError.setBounds(0, 260, 450, 30);
		...
		comboBoxPaises.setBounds(130, 120, 150, 20);
	...
	private void botones() {
		...
		btnConsultar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				item = coordinador.getAmigo(referencia);
				if (item != null) {
		...
		btnEditar.setBounds(130, 230, 150, 20);
