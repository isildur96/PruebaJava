...
public class VentanaAgregarContacto extends JFrame {
    ...
    private void IniciarComponentes() {
        ...
        /*Etiquetas*/
        lblTitulo = new JLabel("Agregar Contacto");
		...
		comboBox.setBounds(130, 150, 150, 20);
		panel.add(comboBox);
    }
    ...
    private void botones() {
    	...
    	btnAgregar.setBounds(130, 240, 150, 20);
        ...
        btnAgregar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	try {
	                ...
	                coordinador.registrarContacto(item);
	                
	                //JOptionPane.showMessageDialog(null, "Equipo agregado " + item.getNombre());
	                
	                lblError.setText("Contacto agregado " + item.getNombre());
