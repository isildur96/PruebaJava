...
public class PokemonPsiquico extends Pokemon{
	...
	private String [] habilidades = {  "Confusión", "Rayoconfuso", "Psicoataque",
									"Hipnosis", "Barrera"};
	...
	public PokemonPsiquico(String nombre, int id, String ataqueN, String ataqueN1, String ataqueT,
			String ataqueT1) {
		// TODO Auto-generated constructor stub
	...
	public String getHabilidadesPpsi() {
