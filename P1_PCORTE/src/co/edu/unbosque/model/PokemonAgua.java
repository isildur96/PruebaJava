...
public class PokemonAgua extends Pokemon{
	...
	private String [] habilidades = {"Tormenta de agua" , "Surf" ,
			"Hidrobomba" , "Danza de la lluvia", "Burbuja, Hidropulso", 
			"Rayo burbuja", "Chorro de agua"  };
	
	
	public PokemonAgua(String th1 , String th2 ,String n) {
	...
	public PokemonAgua(String nombre, int id, String ataqueN, String ataqueN1, String ataqueT,
			String ataqueT1) {
		// TODO Auto-generated constructor stub
	...
	public String getHabilidadesPa() {
