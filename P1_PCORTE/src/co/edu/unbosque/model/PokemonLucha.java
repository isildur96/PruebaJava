...
public class PokemonLucha extends Pokemon{
	...
	private String [] habilidades = { "Golpe karate" , "Puño dinámico" , "Tajo cruzado" ,
									"Patada salto", "Venganza", "Último recurso",
									"Llave inglesa","Patada giro"};
	
	public PokemonLucha() {
		// TODO Auto-generated constructor stub
	}

	public PokemonLucha(String nombre, int id, String ataqueN, String ataqueN1, String ataqueT,
			String ataqueT1) {
		// TODO Auto-generated constructor stub
	...
	public String getHabilidadesPl() {
